...
void close_native(JNIEnv *env, jclass thiz)
{
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (env == NULL) goto bail;

    if (!registerNativeMethods(env, gJavaClassFullName, gMethods,sizeof(gMethods) / sizeof(gMethods[0]))) {
